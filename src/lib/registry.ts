...
export const TOOLS: readonly Tool[] = [
  ...
  },
  {
    ...
    category: 'pdf',
    icon: Combine,
    keywords: ['pdf', 'merge', 'combine', 'join', 'concat'],
    status: 'ready',
    load: () => import('@/tools/pdf-merge/pdf-merge-tool'),
  },
  {
    id: 'pdf-split',
    category: 'pdf',
    icon: Scissors,
    keywords: ['pdf', 'split', 'separate', 'pages', 'burst'],
    status: 'ready',
    load: () => import('@/tools/pdf-split/pdf-split-tool'),
  },
  {
    id: 'pdf-compress',
    category: 'pdf',
  ...
  },
  {
    ...
    category: 'pdf',
    icon: RotateCw,
    keywords: ['pdf', 'rotate', 'pages', 'orientation', 'turn'],
    status: 'ready',
    load: () => import('@/tools/pdf-rotate/pdf-rotate-tool'),
  },
  {
    id: 'pdf-extract',
    category: 'pdf',
    icon: FileOutput,
    keywords: ['pdf', 'extract', 'pages', 'range', 'select', 'subset'],
    status: 'ready',
    load: () => import('@/tools/pdf-extract/pdf-extract-tool'),
  },
  {
    id: 'qr-generate',
    category: 'security',
